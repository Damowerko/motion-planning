...
POLICIES=("c" "c_sq" "d2_sq" "d6_sq" "d9_sq")
for policy in "${POLICIES[@]}"; do
    ./cluster/run_local.sh scripts/baseline.py --policy $policy --n_trials $N_TRIALS --n_workers 10 --max_steps $MAX_STEPS --no-delay --no-scenarios
done
